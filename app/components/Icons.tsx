...
export const Icons = {
  ...
  Syringe: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="m18 2 4 4"/>
      <path d="m17 7 3-3"/>
  ...
  Dna: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="m2 15 10-10"/>
      <path d="m9 18 10-10"/>
      <path d="m14 22 6.5-6.5a4.95 4.95 0 0 0 0-7h0a4.95 4.95 0 0 0-7 0L7 15"/>
      <path d="m3.5 10.5 4.95 4.95a4.95 4.95 0 0 0 7 0h0a4.95 4.95 0 0 0 0-7L9 2"/>
    </svg>
  ),
...
export function getCategoryIcon(category: string, className?: string) {
  ...
  switch (category) {
    case "OB": return <Icons.Pill {...props} />;
    case "OBT": return <Icons.Syringe {...props} />;
    case "SUPLEMEN": return <Icons.Dna {...props} />;
    case "HERBAL": return <Icons.Leaf {...props} />;
    case "ALKES": return <Icons.Stethoscope {...props} />;
    case "IBU_ANAK": return <Icons.Baby {...props} />;
    default: return <Icons.Pill {...props} />;
  }
}
