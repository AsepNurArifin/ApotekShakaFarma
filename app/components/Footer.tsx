        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="w-10 h-10 rounded-xl gradient-primary flex items-center justify-center text-white font-extrabold text-lg">
                SF
              </div>
              <div>
                <div className="font-extrabold text-lg">Shaka Farma</div>
            ...
            <div className="flex gap-3 mt-4">
              <a href={getGeneralWALink()} target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-wa-green/20 flex items-center justify-center text-wa-green hover:bg-wa-green hover:text-white transition-colors btn-interactive" aria-label="WhatsApp">
              ...
              <a href="https://instagram.com/apotekshakafarma" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-pink-500/20 flex items-center justify-center text-pink-400 hover:bg-pink-500 hover:text-white transition-colors btn-interactive" aria-label="Instagram">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-bold text-sm uppercase tracking-wider text-primary-300 mb-4">Navigasi</h3>
            <ul className="space-y-2">
              {[
                { href: "/", label: "Beranda" },
                { href: "/katalog", label: "Katalog Produk" },
                { href: "/promosi", label: "Promosi" },
                { href: "/artikel", label: "Tips Kesehatan" },
